...
if ( class_exists( 'WooCommerce' ) ) {
 ...
 //Add Project post type
    ...
    function weproject_custom_post_type(){
    /*
     * Biến $label để chứa các text liên quan đến tên hiển thị của Post Type trong Admin
     */
    $label = array(
        'name' => 'WeProject', //Tên post type dạng số nhiều
        'singular_name' => 'Project', //Tên post type dạng số ít
    ...
    $args = array(
        ...
        'description' => 'WeProject', //Mô tả của post type
        'supports' => array(
            'title',
    ...
    register_taxonomy('catproject', 'project', array(
		'hierarchical' 			=> true,
		'label' 				=> 'Category WeProjects',
		'singular_label' 		=>  'Category WeProject',
		'rewrite'				=> true,
...
add_action('init', 'weproject_custom_post_type');
